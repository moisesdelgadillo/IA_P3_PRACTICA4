# -*- coding: utf-8 -*-
"""
Created on Sun Jun 16 00:55:52 2024
...
# Crear un grafo de ejemplo (centrales eléctricas y costos de transmisión entre ellas)
G = nx.Graph()
G.add_edge('Central_A', 'Central_B', weight=5)
G.add_edge('Central_A', 'Subestación_C', weight=10)
G.add_edge('Central_B', 'Subestación_D', weight=2)
G.add_edge('Central_B', 'Subestación_E', weight=7)
G.add_edge('Subestación_C', 'Subestación_D', weight=1)
G.add_edge('Subestación_C', 'Subestación_E', weight=3)
G.add_edge('Subestación_D', 'Subestación_E', weight=8)

# Aplicar el algoritmo de Prim
mst = prim_mst(G, 'Central_A')
...
plt.title('Grafo Original (Red de Distribución de Energía)')
...
print("optimización de la red de distribución de energía eléctrica a nivel global.")
print("Cada nodo representará una central eléctrica o una subestación, y cada arista representará el costo de establecer una línea de transmisión entre dos nodos")
print("El objetivo es minimizar el costo total de conectar todas las centrales eléctricas y subestaciones\n\n")
